...
describe('UsersController', () => {
    ...
    describe('getAll', () => {
        ...
        it('should return error if user does not have required roles', async () => {
            ...
            jest.spyOn(usersService, 'getAll').mockRejectedValue(mockUnauthorizedError);
    ...
    describe('getOne', () => {
        ...
        it('should return error if user does not have required roles', async () => {
            const mockUnauthorizedError = new Error('forbidden');
            jest.spyOn(usersService, 'getOne').mockRejectedValue(mockUnauthorizedError);
    ...
    describe('changeRole', () => {
        ...
        it('should return error if user does not have required roles', async () => {
            const mockUnauthorizedError = new Error('forbidden');
            jest.spyOn(usersService, 'changeRole').mockRejectedValue(mockUnauthorizedError);
