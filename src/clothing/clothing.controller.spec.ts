...
describe('ClothingController', () => {
    ...
    describe('create', () => {
        ...
        it('should return error if user does not have required roles', async () => {
            ...
            jest.spyOn(clothingService, 'create').mockRejectedValue(mockUnauthorizedError);
    ...
    describe('deleteById', () => {
        ...
        it('should return error if user does not have required roles', async () => {
            const mockUnauthorizedError = new Error('forbidden');
            jest.spyOn(clothingService, 'deleteById').mockRejectedValue(mockUnauthorizedError);
